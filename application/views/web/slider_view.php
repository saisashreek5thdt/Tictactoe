<!-- Slider -->
         <div id="layerslider">
            ...
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="<?php base_url(); ?>assets/web/img/slider/1.png" class="ls-bg"  alt="Slide background"/>
               <!-- Parallax Image -->
            ...
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="<?php base_url(); ?>assets/web/img/slider/2.png" class="ls-bg"  alt="Slide background"/>
               <!-- Parallax Image -->
               <img src="<?php base_url(); ?>assets/web/img/bee.png" class="ls-l img-responsive hidden-xs hidden-sm parallax1" alt="" data-ls="delayin:1500;easingin:fadeIn;parallaxlevel:7;">
               <!-- Text -->
               ...
               <!-- Parallax Image -->
               <img src="<?php base_url(); ?>assets/web/img/star.png" class="ls-l img-responsive hidden-xs hidden-sm parallax2" alt="" data-ls="delayin:1500;easingin:fadeIn;parallaxlevel:6;">
            </div>
            <!-- Slide 3 -->
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="<?php base_url(); ?>assets/web/img/slider/3.png" class="ls-bg"  alt="Slide background"/>
               <!-- Parallax Image -->
               <img src="<?php base_url(); ?>assets/web/img/sun.png" class="ls-l img-responsive hidden-xs hidden-sm parallax1" alt="" data-ls="delayin:1000;easingin:fadeIn;parallaxlevel:7;">
               <!-- Text -->
               <!--<div class="ls-l header-text"  data-ls="offsetxin:0;durationin:2000;delayin:1500;easingin:easeOutElastic;rotatexin:-90;transformoriginin:50% top 0;offsetxout:-200;durationout:1000;parallaxlevel:2;">
            ...
            <div class="ls-slide" data-ls="transition2d:104;timeshift:-2000;">
               <!-- Background image -->
               <img src="<?php base_url(); ?>assets/web/img/slider3.png" class="ls-bg"  alt="Slide background"/>
			   <!-- Parallax Image -->
               <img src="<?php base_url(); ?>assets/web/img/bee.png" class="ls-l img-responsive hidden-xs hidden-sm parallax1" alt="" data-ls="delayin:1500;easingin:fadeIn;parallaxlevel:7;">
               <!--<div class="ls-l header-text" data-ls="offsetxin:0;durationin:2000;delayin:1500;easingin:easeOutElastic;rotatexin:-90;transformoriginin:50% top 0;offsetxout:-200;durationout:1000;parallaxlevel:2;">
                  <h1>Quality daycare</h1>
