         ...
         <div class="parallax-object2 hidden-sm hidden-xs" data-0="opacity:1;"
            ...
            data-center-center="transform:translatey(-180%);">
            <!-- Image -->
            <img src="<?php base_url(); ?>assets/web/img/parallaxobject2.png" alt="">
         </div>
         <?php 
         ...
         <div class="parallax-object3 hidden-sm hidden-xs" data-0="opacity:1;"
            ...
            <img src="<?php base_url(); ?>assets/web/img/parallaxobject3.png" alt="">
         </div>
         <?php 
		  	include ('price_view.php');
		  ?>
         <?php 
		  	include ('more_info_view.php');
		  ?><?php */?>
         <?php 
		  	include ('contact_more_view.php');
		  ?>
         <!-- Footer -->	
