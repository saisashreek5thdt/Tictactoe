         ...
         <nav class="navbar navbar-custom navbar-fixed-top">
            ...
            <div class="navbar-header">
               ...
               <div class="navbar-brand-centered page-scroll">
                  <a href="<?php base_url(); ?>home"><img src="<?php base_url(); ?>assets/web/img/logo/logo.ico"  alt=""></a>
               </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-brand-centered">
               <div class="container">
				  ...
				  <ul class="nav navbar-nav page-scroll navbar-right">
					 <li>
						 <a href="https://www.facebook.com/Tic-Tac-Toe-Preschool-105813518319926" target="_blank">
							 <img src="<?php base_url(); ?>assets/web/img/icons/icon_fb.png" class="img-responsive" />
						 </a>
					 </li> 
                     <li>
                        <a href="https://instagram.com/tictactoe_preschool?igshid=123j4ebrke865" target="_blank">
							<img src="<?php base_url(); ?>assets/web/img/icons/icon_insta.png" class="img-responsive" />
						</a>
                     </li>
                     <li>
                        <a href="#" target="_blank">
							<img src="<?php base_url(); ?>assets/web/img/icons/icon_twitter.png" class="img-responsive" />
						</a>
                     </li>
                  </ul> 
               </div>
