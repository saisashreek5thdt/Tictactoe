               ...
               <section class="section">
				  ...
				  <div class="row">
                        <div class="col-12">
                           <div class="card">
                              <div class="card-header">
                                 <h4>Our Fee Structure - Info</h4>
                              </div>
                              <div class="card-body">
								 <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Select School Branch</label>
                                    <div class="col-sm-12 col-md-7">
                                       <select class="form-control selectric">
                                          <option>Select School Branch</option>
								 ...
								 <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Select Class Name</label>
                                    <div class="col-sm-12 col-md-7">
                                       <select class="form-control selectric">
