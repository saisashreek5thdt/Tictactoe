                                 ...
                                 <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                       <div class="card-content">
                                          <h5 class="font-15">New Branches</h5>
                           ...
                           <div class="card-statistic-4">
                              <div class="align-items-center justify-content-between">
                                 <div class="row ">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                       <div class="card-content">
                                          <h5 class="font-15">Create Branches</h5>
                                          <h2 class="mb-3 font-18"></h2>
                                          <p class="mb-0">
											  <a href="<?php base_url(); ?>contact_create" style="text-decoration: none !important;">Create Branch</a>
										  </p>
                                       </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
						   ...
						   <article class="article article-style-b">
							  ...
							  <div class="article-details">
								 ...
								 <div class="article-cta">
									<a href="<?php base_url(); ?>contact_view">Read More <i class="fas fa-chevron-right"></i></a>
								 </div>
							  </div>
						   </article>
						</div>
