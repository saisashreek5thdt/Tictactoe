						   ...
						   <div class="card">
							  ...
							  <div class="card-body">
								  <form class="form-inline">
                                    <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Create Our Approach Tab Name">
                                    <div class="input-group mb-2 mr-sm-2">
                                       <button class="btn btn-primary">Create Our Approach Tab</button>
                                    </div>
                                 </form>
							  </div> 
						   </div>
                        ...
                        <div class="col-12">
                           <div class="card">
                              ...
                              <div class="card-body">
								 ...
								 <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tab Icon/Image</label>
                                    <div class="col-sm-12 col-md-7">
                                       <div class="custom-file">
										   <input type="file" class="custom-file-input" id="customFile">
										   <label class="custom-file-label" for="customFile">Choose file</label>
