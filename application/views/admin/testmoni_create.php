               ...
               <section class="section">
                  <div class="row">
					  <!--<div class="col-8 col-md-6 col-lg-6">
					   ...
					   <div class="col-4 col-md-6 col-lg-6">
						   <div class="card">
							   <div class="card-header">
								 <h4>Testimonial - Create Parent Name</h4>
							  </div>
							  <div class="card-body">
								  <form class="form-inline">
                                    <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Create Parent Name">
                                    <div class="input-group mb-2 mr-sm-2">
                                       <button class="btn btn-primary">Create Parent Name</button>
                                    </div>
                                 </form>
							  </div> 
						   </div>
				  ...
				  <div class="row">
                        <div class="col-12">
                           <div class="card">
                              <div class="card-header">
                                 <h4>Testimonial Team - Info</h4>
                              </div>
                              <div class="card-body">
								 <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Select Parent Name</label>
                                    <div class="col-sm-12 col-md-7">
                                       <select class="form-control selectric">
										  <option>Select Parent Name</option> 
                                          <option>Parent Name 1</option>
                                          <option>Parent Name 2</option>
                                          <option>Parent Name 3</option>
                                       </select>
                                    </div>
                                 </div>
								 <div class="form-group row mb-4">
								 ...
								 <div class="form-group row mb-4">
									<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Testimonial Image</label>
									<div class="col-sm-12 col-md-7">
										<div class="custom-file">
										   <input type="file" class="custom-file-input" id="customFile">
										   <label class="custom-file-label" for="customFile">Choose file</label>
